...
public class PrescriptionRecords {
	...
	public PrescriptionRecords(String userId, String username, String prescribedBy, String medicalCondition,
			String allergies, int medicDuration, String prescriptions, String prescriptionNotes, Date createdAt) {
		super();
		this.userId = userId;
