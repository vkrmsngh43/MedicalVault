...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
  ...
  @Autowired AccessSecurityService accessSecurityService;
  ...
  @Bean
  public CustomAuthFilter customAuthFilterBean() throws Exception {
    CustomAuthFilter authenticationTokenFilter = new CustomAuthFilter();
  ...
  protected void configure(HttpSecurity httpSecurity) throws Exception {
    ...
    httpSecurity.addFilterBefore(
        customAuthFilterBean(), UsernamePasswordAuthenticationFilter.class);
  }
}
