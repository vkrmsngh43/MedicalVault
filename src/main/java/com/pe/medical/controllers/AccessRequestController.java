...
public class AccessRequestController {
	...
	/**
	 * This API is called to place an access request before accessing the medical records of
	 * a patient.
	 * @param userId
	 * @return
	 * @throws Exception
	...
	@PreAuthorize("@accessSecurityService.hasAccessToMedicalRecords() OR @accessSecurityService.hasAccessToPrescriptionRecords()")
