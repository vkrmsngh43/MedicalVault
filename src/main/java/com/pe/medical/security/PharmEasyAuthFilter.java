 ...
 *
 */
public class PharmEasyAuthFilter extends UsernamePasswordAuthenticationFilter{
	
	private static Logger logger = LoggerFactory.getLogger(PharmEasyAuthFilter.class);
